...
console.log(`A linguagem de progrmação que o usuário mais gosta é a(o) ${resposta}`);
valor1 = 10;
valor2 = 2;
...
let numero = prompt("Digite um numero para verificar sse é positivi ou negativo.");
    if(numero>0){
